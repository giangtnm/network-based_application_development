<div class="tab-content">
    ...
    <div class="content-item tab-pane fade in active" id="section1">
        ...
        <div class="item">
            ...
            <div class="item-content">
                <a href="chitiet.php?xem=chitiet&id_monan=<?php echo $dong_all['ma_monan'] ?>" class="name1">
                    <div class="name" style="text-align: center; padding-top: 25px;">
    ...
    <div class="content-item tab-pane fade" id="section2">
        ...
        <div class="item" style="height: 375px">
            <div class="image">
                <img src="admin/modules/quanlychitietmonan/upload/<?php echo $dong['hinhanh']?>" alt="">
            </div>
            <div class="item-content">
                <div class="review">
