...
<form action="modules/quanlymonan/xuly.php?id_nhahang=<?php echo $dong['ma_nhahang'] ?>&id_monan=<?php echo $dong['ma_monan'] ?>" method="post" enctype="multipart/form-data">
 <table width="100%" border="1">
  <tbody>
    <tr>
      <td colspan="2"><div align="center">Sửa món ăn vào nhà hàng</div></td>
    </tr>
    <tr>
      <td>Mã nhà hàng</td>
    ...
    <tr>
      <td>Giá</td>
      <td><input type="text" name="giaca" value="<?php echo $dong['giaca'] ?>"></td>
    </tr>
    <tr>
      <td>Đánh giá</td>
      <td><input type="text" name="danhgia" value="<?php echo $dong['danhgia'] ?>"></td>
    </tr>
    <tr>
