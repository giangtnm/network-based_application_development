...
<table width="100%" border="1">
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="index.php?quanly=quanlynhahang&ac=sua&id_nhahang=<?php echo $dong['ma_nhahang'] ?>">Sửa</a>
            </td>
            <td>
                <a href="modules/quanlynhahang/xuly.php?id_nhahang=<?php echo $dong['ma_nhahang'] ?>">Xóa</a>
            </td>
        </tr>
        <?php
            }
